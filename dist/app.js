...
const authStation_1 = __importDefault(require("./middleware/authStation"));
...
app.use(cors_1.default({ origin: helper_1.isDev ? 'http://localhost:3000' : /starcar\.local$/, credentials: true }));
