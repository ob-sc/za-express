...
const status = async (query, id) => {
    ...
    const statusArray = [
        ...
        {
            name: 'mail',
            value: statusHelper_1.getValue(result.domain) ? `${result.domain}@starcar.de` : false,
            done: !!statusHelper_1.getValue(result.domain),
            label: 'E-Mail',
            required: true,
        },
        ...
        {
            name: 'hardware',
            value: statusHelper_1.getValue(result.hardware),
            done: !!statusHelper_1.getValue(result.hardware),
            label: 'Hardware',
